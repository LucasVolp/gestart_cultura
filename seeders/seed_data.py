...
event2._Event__ratings.append(rating2)
...
event3._Event__tiers.extend([tier3_1, tier3_2])
rating3 = Rating(id=uuid4(), user=user1, event=event3, rate=5, comment="Jazz maravilhoso!")
event3._Event__ratings.append(rating3)
